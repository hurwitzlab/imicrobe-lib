use utf8;
package CMore::Schema::Result::SampleToOntology;
...
Related object: L<CMore::Schema::Result::Ontology>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yiYorlnthvu+iwKgOicS+g
