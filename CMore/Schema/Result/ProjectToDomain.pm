use utf8;
package CMore::Schema::Result::ProjectToDomain;
...
Related object: L<CMore::Schema::Result::Domain>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2kOCYlqtpkvnALcN1aav0g
