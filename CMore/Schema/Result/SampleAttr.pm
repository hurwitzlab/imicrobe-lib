use utf8;
package CMore::Schema::Result::SampleAttr;
...
Related object: L<CMore::Schema::Result::SampleAttrType>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ish7pAawzuYgJA6+FDqrXw
